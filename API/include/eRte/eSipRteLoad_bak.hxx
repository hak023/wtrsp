...
template <unsigned int E_MAX_TIMEINTERVAL=1000, unsigned int E_MAX_PERIOD_SIZE=100 >
//template <unsigned int E_MAX_TIMEINTERVAL=1000, unsigned int E_MAX_PERIOD_SIZE=1 >
