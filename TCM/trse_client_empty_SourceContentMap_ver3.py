...
def TcpSendMsg(SendMsg):
    ...
    header='WTRSTP/1.000000000000000%06d' % len(compress_msg)
...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="targatfile.k3g" ID="3" NASCode="10" Path="path1/path2/path3">'
    ...
    CreateJobRequest += '<Transcoding SourceContentID="0" TargetContentID="0"/>'
    CreateJobRequest += '</TranscodingList>'
...
def SendAliveCheck():
    ...
    while not SHUTDOWN :
        ...
        LinkTestRequest += '<Error Code="" Description="한글" Source="테스트"/>'
