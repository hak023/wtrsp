...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent BinaryData="" File="" Path="" NASCode="" ID="1">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="" ID="100" NASCode="" Path="">'
    CreateJobRequest += '<Container ID="3GP">'
    CreateJobRequest += '<VideoCodec BitRate="256000" Height="144" ID="MPEG4" MaxFrameRate="15" VariableFrameRate="" Width="176"/>'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="" ID="101" NASCode="" Path="">'
    CreateJobRequest += '<Container ID="K3G">'
    CreateJobRequest += '<VideoCodec BitRate="256000" Height="144" ID="MPEG4" MaxFrameRate="15" VariableFrameRate="" Width="176"/>'
    CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="12200" Channel="1" ID="AMR" SampleRate="8000"/>'
    CreateJobRequest += '<Metadata Album="" Artist="" Comment="" Genre="" Title="" Track="" Year=""/>'
    ...
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="" ID="103" NASCode="" Path="">'
    CreateJobRequest += '<Container ID="MP4">'
    CreateJobRequest += '<VideoCodec BitRate="256000" Height="144" ID="MPEG4" MaxFrameRate="15" VariableFrameRate="" Width="176"/>'
    CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="12200" Channel="1" ID="AAC" SampleRate="8000"/>'
    CreateJobRequest += '<Metadata Album="" Artist="" Comment="" Genre="" Title="" Track="" Year=""/>'
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '</TargetContentMap>'
    CreateJobRequest += '<TranscodingList>'
    CreateJobRequest += '<Transcoding SourceContentID="1" TargetContentID="100"/>'
    ...
    CreateJobRequest += '<Transcoding SourceContentID="1" TargetContentID="103"/>'
    CreateJobRequest += '</TranscodingList>'
