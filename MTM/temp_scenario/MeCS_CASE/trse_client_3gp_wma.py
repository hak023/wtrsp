...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent NASCode="67" File="Sia_Chandelier_401.k3g" Path="vwtrss/audio" ID="0">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="3gp_To_wma.wma" ID="1" NASCode="10" Path="test/lhj">'
    ...
    CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="64000" Channel="2" ID="WMA2" SampleRate="44100"/>'
