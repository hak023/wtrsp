...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent File="ive_love_dive.mp3" ID="1" NASCode="67" Path="vwtrss/audio">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="mp3_To_mp3c_meta.mp3" ID="1" NASCode="10" Path="test/lhj" Size="30KB">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="mp3_To_mp3_meta.mp3" ID="2" NASCode="10" Path="test/lhj">'
    CreateJobRequest += '<Container ID="MP3">'
    CreateJobRequest += '<VideoCodec BitRate="0" Height="0" ID="NONE" MaxFrameRate="0" VariableFrameRate="0" Width="0"/>'
    CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="320000" Channel="2" ID="MP3" SampleRate="44100"/>'
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="mp3_To_wma_meta.wma" ID="3" NASCode="10" Path="test/lhj">'
