...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent BinaryData="" File="ive_love_dive.mp3" Path="vwtrss/audio" NASCode="67" ID="0">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="mp3_To_mp3.mp3" ID="2" NASCode="10" Path="test/lhj">'
    CreateJobRequest += '<Container ID="MP3">'
