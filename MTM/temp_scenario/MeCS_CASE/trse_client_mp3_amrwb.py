...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent BinaryData="" File="The_Best_of_Mozart.mp3" Path="vwtrss/audio" NASCode="67" ID="0">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="mp3_To_amrwb.awb" ID="7" NASCode="10" Path="test/lhj">'
