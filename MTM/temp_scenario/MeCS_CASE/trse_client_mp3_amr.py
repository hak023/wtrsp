...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent BinaryData="" File="GalaxyNote20_48000.mp3" Path="vwtrss/audio" NASCode="67" ID="0">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="mp3_To_amr.amr" ID="8" NASCode="10" Path="test/lhj">'
