...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent File="82461191_orig.jpg" ID="1" NASCode="67" Path="vwtrss/audio">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="ticket_240.jpg" ID="1" NASCode="10" Path="test/lhj" Size="40KB">'
    CreateJobRequest += '<Container ID="JPEG">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="ticket_120.jpg" ID="2" NASCode="10" Path="test/lhj" Size="40KB">'
    CreateJobRequest += '<Container ID="JPEG">'
    CreateJobRequest += '<VideoCodec BitRate="64000" Height="120" ID="JPEG" MaxFrameRate="" VariableFrameRate="" Width="120"/>'
    CreateJobRequest += '<AudioCodec BitPerSample="" BitRate="" Channel="" ID="JPEG" SampleRate=""/>'
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="ticket_90.jpg" ID="3" NASCode="10" Path="test/lhj" Size="40KB">'
    CreateJobRequest += '<Container ID="JPEG">'
    CreateJobRequest += '<VideoCodec BitRate="64000" Height="90" ID="JPEG" MaxFrameRate="" VariableFrameRate="" Width="90"/>'
    CreateJobRequest += '<AudioCodec BitPerSample="" BitRate="" Channel="" ID="" SampleRate=""/>'
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="ticket_50.jpg" ID="4" NASCode="10" Path="test/lhj" Size="40KB">'
    CreateJobRequest += '<Container ID="JPEG">'
    ...
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="ticket_25.jpg" ID="5" NASCode="10" Path="test/lhj" Size="40KB">'
    CreateJobRequest += '<Container ID="JPEG">'
    CreateJobRequest += '<VideoCodec BitRate="64000" Height="25" ID="JPEG" MaxFrameRate="" VariableFrameRate="" Width="25"/>'
    CreateJobRequest += '<AudioCodec BitPerSample="" BitRate="" Channel="" ID="JPEG" SampleRate=""/>'
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="ticket_600.jpg" ID="6" NASCode="10" Path="test/lhj" Size="40KB">'
    CreateJobRequest += '<Container ID="JPEG">'
