...
class TrsgTransport: public TrspSocketCom 
{
public:
	TrsgTransport();
	...
	void m_fnCbkNotify(ETcpNotiEv_t _eT, const eSipUtil::Net5Tuple_t &_rstNet5Tuple, eSipUtil::ETransportErr_t _eDisconErr);
