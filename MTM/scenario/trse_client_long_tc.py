...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent File="long_tc_music.mp3" ID="1" NASCode="67" Path="vwtrss/mp3">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="longTcTestFile_1.mp3" ID="1" NASCode="10" Path="vwtrss/test">'
    CreateJobRequest += '<Container ID="MP3">'
    CreateJobRequest += '<VideoCodec BitRate="" Height="" ID="" MaxFrameRate="" VariableFrameRate="" Width=""/>'
    CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="32000" Channel="1" ID="MP3" SampleRate="44100"/>'
