...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent File="266245.3g2" ID="1" NASCode="11" Path="test/lhj">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="3GPTestFile_1.wma" ID="1" NASCode="10" Path="test/lhj">'
    ...
    CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="8000" Channel="1" ID="WMA2" SampleRate="12200"/>'
    CreateJobRequest += '<Metadata Album="" Artist="" Comment="" Genre="" Title="" Track="" Year=""/>'
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    #CreateJobRequest += '<TargetContent BinaryData="" File="266245_1.3g2" ID="2" NASCode="10" Path="test/lhj">'
    #CreateJobRequest += '<Container ID="WMV">'
    #CreateJobRequest += '<VideoCodec BitRate="0" Height="0" ID="WMV3" MaxFrameRate="0" VariableFrameRate="0" Width="0"/>'
    #CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="8000" Channel="1" ID="WMA2" SampleRate="12200"/>'
    #CreateJobRequest += '<Metadata Album="" Artist="" Comment="" Genre="" Title="" Track="" Year=""/>'
    #CreateJobRequest += '</Container>'
    #CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="3GPTestFile_3.k3g" ID="3" NASCode="10" Path="test/lhj">'
    CreateJobRequest += '<Container ID="3GP">'
    ...
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="3GPTestFile_4.3gp" ID="4" NASCode="10" Path="test/lhj">'
    CreateJobRequest += '<Container ID="3GP">'
    CreateJobRequest += '<VideoCodec BitRate="0" Height="0" ID="MPEG4" MaxFrameRate="0" VariableFrameRate="0" Width="0"/>'
    CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="8000" Channel="1" ID="AMR" SampleRate="12200"/>'
    CreateJobRequest += '<Metadata Album="" Artist="" Comment="" Genre="" Title="" Track="" Year=""/>'
