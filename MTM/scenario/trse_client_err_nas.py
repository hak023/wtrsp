...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent File="alienbridge2.wav" ID="1" NASCode="77" Path="vwtrss/wav">'
    ...
    #CreateJobRequest += '<TargetContent BinaryData="" File="WAVTestFile_1.wma" ID="1" NASCode="" Path="vwtrss/test">'
