...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent BinaryData="" File="6430001361.mp3" Path="vwtrss/audio" NASCode="67" ID="0">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="mp3_To_aac.aac" ID="5" NASCode="10" Path="vwtrss/test">'
    CreateJobRequest += '<Container ID="AAC">'
    CreateJobRequest += '<VideoCodec BitRate="" Height="" ID="" MaxFrameRate="" VariableFrameRate="" Width=""/>'
    CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="192000" Channel="2" ID="AAC" SampleRate="44100"/>'
    CreateJobRequest += '</Container>'
