...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent BinaryData="" File="6420001361.mp3" Path="vwtrss/audio" NASCode="67" ID="0">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="mp3_To_amr.amr" ID="8" NASCode="10" Path="vwtrss/test">'
