...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent NASCode="67" File="6430001449.k3g" Path="vwtrss/audio" ID="0">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="3gp_To_wma.wma" ID="1" NASCode="10" Path="vwtrss/test">'
