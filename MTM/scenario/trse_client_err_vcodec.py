...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="tc_266245.amr" ID="1" NASCode="10" Path="test/lhj">'
    CreateJobRequest += '<Container ID="K3G">'
    CreateJobRequest += '<VideoCodec BitRate="256000" Height="144" ID="MPEG2" MaxFrameRate="15" VariableFrameRate="" Width="176"/>'
