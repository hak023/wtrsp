...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '<SourceContent File="266245.3g2" ID="1" NASCode="10" Path="test/lhj">'
    CreateJobRequest += '<Container ID="MDF">'
    ...
    CreateJobRequest += '<TargetContent BinaryData="" File="tc_266245.qcelp" ID="102" NASCode="10" Path="test/lhj">'
    CreateJobRequest += '<Container ID="UTF">'
    CreateJobRequest += '<VideoCodec ID="UTF" Width="" Height="" MaxFrameRate="" BitRate="" VariableFrameRate="" />'
    CreateJobRequest += '<AudioCodec ID="UTF" Channel="" SampleRate="" BitRate="" BitPerSample="" />'
