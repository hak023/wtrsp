...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="MP3TestFile_4.k3g" ID="4" NASCode="10" Path="vwtrss/test">'
    CreateJobRequest += '<Container ID="K3G">'
    CreateJobRequest += '<VideoCodec BitRate="" Height="" ID="" MaxFrameRate="" VariableFrameRate="" Width=""/>'
    CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="128000" Channel="2" ID="AAC" SampleRate="44100"/>'
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="MP3TestFile_5.3gp" ID="5" NASCode="10" Path="vwtrss/test">'
    CreateJobRequest += '<Container ID="3GP">'
    CreateJobRequest += '<VideoCodec BitRate="" Height="" ID="" MaxFrameRate="" VariableFrameRate="" Width=""/>'
    CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="64000" Channel="2" ID="AAC" SampleRate="44100"/>'
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    ...
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="MP3TestFile_8.amr" ID="8" NASCode="10" Path="vwtrss/test">'
    CreateJobRequest += '<Container ID="AMR">'
    CreateJobRequest += '<VideoCodec BitRate="" Height="" ID="" MaxFrameRate="" VariableFrameRate="" Width=""/>'
    CreateJobRequest += '<AudioCodec BitPerSample="16" BitRate="12200" Channel="1" ID="AMR" SampleRate="8000"/>'
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="MP3TestFile_9.g711" ID="9" NASCode="10" Path="vwtrss/test">'
    ...
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="MP3TestFile_10.mmf" ID="10" NASCode="10" Path="vwtrss/test">'
    ...
    CreateJobRequest += '<Transcoding SourceContentID="0" TargetContentID="9"/>'
    CreateJobRequest += '<Transcoding SourceContentID="0" TargetContentID="10"/>'
    CreateJobRequest += '</TranscodingList>'
