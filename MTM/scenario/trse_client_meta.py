...
def SendCreateJobRequest():
    ...
    CreateJobRequest += '</Container>'
    CreateJobRequest += '</TargetContent>'
    CreateJobRequest += '<TargetContent BinaryData="" File="MetaTestFile_4.vox" ID="4" NASCode="10" Path="vwtrss/test">'
    ...
    CreateJobRequest += '<Transcoding SourceContentID="1" TargetContentID="4"/>'
    CreateJobRequest += '</TranscodingList>'
