...
public:
	...
	static void m_fnGetServiceName(KString &_rclsXml, KString &_rclsServiceName);
	...
	static void m_fnMakeJobStatusChangedNotify_Created(KString &_rclsXml, KString &_rclsServiceName, KString &_rclsJobStatusChangedNotify);
	static void m_fnMakeJobStatusChangedNotify_Waiting(KString &_rclsXml, KString &_rclsJobStatusChangedNotify);
	static void m_fnMakeJobStatusChangedNotify_JobStarted(KString &_rclsXml, KString &_rclsServiceName, unsigned int _unTranscodingList, KString &_rclsJobStatusChangedNotify);
	static void m_fnMakeJobStatusChangedNotify_TC_Started(KString &_rclsXml, KString &_rclsServiceName, SourceContent *_pclsSource, TargetContent *_pclsTarget, unsigned int _unFail, unsigned int _unSuccess, unsigned int _unTargetIdx, KString &_rclsJobStatusChangedNotify);
	...
	static void m_fnMakeJobStatusChangedNotify_JobStopped(KString &_rclsXml, KString &_rclsServiceName, KString &_rclsJobStatusChangedNotify);
	static void m_fnMakeJobStatusChangedNotify_Destroyed(KString &_rclsXml, KString &_rclsServiceName, unsigned int _unTranscodingList, ETrssCodeSet_t _eSt, KString &_rclsJobStatusChangedNotify);
	/*Util*/
	static void m_fnGetCurrentTime(KString &_rclsCurrent);
	static void m_fnXmlFormatter(KString & _rclsXml, KString & _rclsXmlFormat);
	static void m_fnConvertQuote(const char *_rclsStr, KString &_rclsResult);
};
